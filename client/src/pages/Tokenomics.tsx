          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <Card className="p-8 bg-gradient-to-br from-primary/10 to-primary/5">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold" data-testid="heading-bnb-token">BNB Token</h2>
              </div>
            ...
            <Card className="p-8 bg-gradient-to-br from-secondary/10 to-secondary/5">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold" data-testid="heading-bnball-token">BNBALL Token</h2>
              </div>
          ...
          <Card className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className="text-3xl font-bold font-mono mb-2" data-testid="stat-community-rewards">40%</div>
                <div className="text-sm text-muted-foreground">Community & Rewards</div>
              </div>
              <div className="text-center">
                <TrendingUp className="w-8 h-8 text-primary mx-auto mb-3" />
                <div className="text-3xl font-bold font-mono mb-2" data-testid="stat-liquidity-pool">30%</div>
                <div className="text-sm text-muted-foreground">Liquidity Pool</div>
              </div>
              <div className="text-center">
                <Zap className="w-8 h-8 text-primary mx-auto mb-3" />
                <div className="text-3xl font-bold font-mono mb-2" data-testid="stat-team-development">30%</div>
